...
public abstract class InvincibleSuitDarkItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("invincible_conquest:invincible_suit_dark"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, InvincibleConquestModItems.INVINCIBLE_SUIT_DARK_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
		...
		}, InvincibleConquestModItems.INVINCIBLE_SUIT_DARK_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
		...
		}, InvincibleConquestModItems.INVINCIBLE_SUIT_DARK_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
		...
		}, InvincibleConquestModItems.INVINCIBLE_SUIT_DARK_BOOTS.get());
	}

	public InvincibleSuitDarkItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends InvincibleSuitDarkItem {
		public Helmet() {
		...
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return ResourceLocation.parse("invincible_conquest:textures/entities/dark_invincible_suit.png");
		}
	}

	public static class Chestplate extends InvincibleSuitDarkItem {
		public Chestplate() {
	...
	public static class Leggings extends InvincibleSuitDarkItem {
		public Leggings() {
	...
	public static class Boots extends InvincibleSuitDarkItem {
		public Boots() {
