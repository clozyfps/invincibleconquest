...
public record StatMenuMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<StatMenuMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(InvincibleConquestMod.MODID, "key_stat_menu"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InvincibleConquestMod.addNetworkMessage(StatMenuMessage.TYPE, StatMenuMessage.STREAM_CODEC, StatMenuMessage::handleData);
	}
}
