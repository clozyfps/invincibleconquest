...
public record MenuAbilityTechJacketButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	}, (RegistryFriendlyByteBuf buffer) -> new MenuAbilityTechJacketButtonMessage(buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt()));
	@Override
