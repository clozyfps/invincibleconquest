...
import net.clozynoii.invincibleconquest.entity.model.FlaxanGunmanModel;
...
public class FlaxanGunmanRenderer extends GeoEntityRenderer<FlaxanGunmanEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FlaxanGunmanEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
