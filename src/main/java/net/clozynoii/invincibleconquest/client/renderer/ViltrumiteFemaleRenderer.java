...
import net.clozynoii.invincibleconquest.entity.model.ViltrumiteFemaleModel;
...
public class ViltrumiteFemaleRenderer extends GeoEntityRenderer<ViltrumiteFemaleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ViltrumiteFemaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
