...
import net.clozynoii.invincibleconquest.entity.model.DimensionalPortalModel;
...
public class DimensionalPortalRenderer extends GeoEntityRenderer<DimensionalPortalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, DimensionalPortalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
