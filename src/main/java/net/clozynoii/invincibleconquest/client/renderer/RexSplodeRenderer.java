...
import net.clozynoii.invincibleconquest.entity.model.RexSplodeModel;
...
public class RexSplodeRenderer extends GeoEntityRenderer<RexSplodeEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RexSplodeEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
