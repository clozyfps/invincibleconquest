...
import net.clozynoii.invincibleconquest.entity.model.ViltrumiteMaleModel;
...
public class ViltrumiteMaleRenderer extends GeoEntityRenderer<ViltrumiteMaleEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ViltrumiteMaleEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
