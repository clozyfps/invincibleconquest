...
public class MenuAbilityPortalScreen extends AbstractContainerScreen<MenuAbilityPortalMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 95, this.topPos + -43, Mth.clamp((int) ReturnSlot1Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 95, this.topPos + -22, Mth.clamp((int) ReturnSlot2Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 95, this.topPos + -1, Mth.clamp((int) ReturnSlot3Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 95, this.topPos + 20, Mth.clamp((int) ReturnSlot4Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 95, this.topPos + 41, Mth.clamp((int) ReturnSlot5Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 116, this.topPos + -32, Mth.clamp((int) ReturnSlot6Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 116, this.topPos + -11, Mth.clamp((int) ReturnSlot7Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 116, this.topPos + 10, Mth.clamp((int) ReturnSlot8Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 116, this.topPos + 31, Mth.clamp((int) ReturnSlot9Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);

		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/abilities_sprite_portal.png"), this.leftPos + 116, this.topPos + 52, Mth.clamp((int) ReturnSlot10Procedure.execute(entity) * 16, 0, 16), 0, 16, 16, 32, 16);
