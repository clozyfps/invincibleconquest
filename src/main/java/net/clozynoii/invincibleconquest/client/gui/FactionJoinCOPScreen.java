...
public class FactionJoinCOPScreen extends AbstractContainerScreen<FactionJoinCOPMenu> implements WidgetScreen {
	...
	public FactionJoinCOPScreen(FactionJoinCOPMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(ResourceLocation.parse("invincible_conquest:textures/screens/menu_join_cop.png"), this.leftPos + -214, this.topPos + -120, 0, 0, 427, 240, 427, 240);
