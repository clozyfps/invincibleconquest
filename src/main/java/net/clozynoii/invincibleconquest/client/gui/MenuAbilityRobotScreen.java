...
public class MenuAbilityRobotScreen extends AbstractContainerScreen<MenuAbilityRobotMenu> {
	...
	public void init() {
		...
		imagebutton_tab_top_unselected = new ImageButton(this.leftPos + -89, this.topPos + -109, 26, 32,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/tab_top_unselected.png"), ResourceLocation.parse("invincible_conquest:textures/screens/tab_top_unselected.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(0, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		imagebutton_tab_bottom_unselected = new ImageButton(this.leftPos + -89, this.topPos + 80, 26, 32,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/tab_bottom_unselected.png"), ResourceLocation.parse("invincible_conquest:textures/screens/tab_bottom_unselected.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(1, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x = new ImageButton(this.leftPos + 95, this.topPos + -43, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(2, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x1 = new ImageButton(this.leftPos + 95, this.topPos + -22, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(3, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x2 = new ImageButton(this.leftPos + 95, this.topPos + -1, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(4, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 4, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x3 = new ImageButton(this.leftPos + 95, this.topPos + 20, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(5, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 5, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x4 = new ImageButton(this.leftPos + 95, this.topPos + 41, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(6, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 6, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x5 = new ImageButton(this.leftPos + 116, this.topPos + -32, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(7, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 7, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x6 = new ImageButton(this.leftPos + 116, this.topPos + -11, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(8, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 8, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x7 = new ImageButton(this.leftPos + 116, this.topPos + 10, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(9, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 9, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x8 = new ImageButton(this.leftPos + 116, this.topPos + 31, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(10, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 10, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
		...
		imagebutton_blank16x9 = new ImageButton(this.leftPos + 116, this.topPos + 52, 16, 16,
				new WidgetSprites(ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png"), ResourceLocation.parse("invincible_conquest:textures/screens/blank16x.png")), e -> {
					if (true) {
						PacketDistributor.sendToServer(new MenuAbilityRobotButtonMessage(11, x, y, z));
						MenuAbilityRobotButtonMessage.handleButtonAction(entity, 11, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
