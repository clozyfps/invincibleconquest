...
public class TelekinesisAbilityProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerCurrentStamina >= staminacost) {
			...
			if (!(entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(InvincibleConquestModMobEffects.ATOM_CONTROL_EFFECT))) {
			...
			} else if (entity instanceof LivingEntity _livEnt5 && _livEnt5.hasEffect(InvincibleConquestModMobEffects.ATOM_CONTROL_EFFECT)) {
				if (entity instanceof LivingEntity _entity)
