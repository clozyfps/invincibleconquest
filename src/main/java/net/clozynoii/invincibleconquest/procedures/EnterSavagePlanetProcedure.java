...
public class EnterSavagePlanetProcedure {
					...
					if (entityiterator.isPassenger()) {
						if ((entityiterator.getVehicle()) instanceof SpaceshipEntity) {
							...
							if (entityiterator instanceof ServerPlayer _player && !_player.level().isClientSide()) {
								ResourceKey<Level> destinationType = ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse("invincible_conquest:savage_world"));
