...
public class StrongPunchPlayerKnockbackProcedure {
	public static void execute(Entity entity, Entity sourceentity) {
		...
		vecX = vecX * sourceentity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerStrength;
		vecY = vecY * sourceentity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerStrength;
		vecZ = vecZ * sourceentity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerStrength;
		...
		if (sourceentity.getXRot() >= 70) {
			...
			vecY = vecY * sourceentity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerStrength;
			vecZ = vecZ * 0;
			entity.push(0, ((-2) - sourceentity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerStrength / 20), 0);
			...
			vecY = vecY * 2;
			vecZ = vecZ * 0;
			entity.push(vecX, (2 + sourceentity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerStrength / 20), vecZ);
