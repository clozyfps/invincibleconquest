...
public class AirDensityAbilityProcedure {
	public static void execute(Entity entity) {
		...
		if (entity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerCurrentStamina >= staminacost) {
			...
			if (!(entity instanceof LivingEntity _livEnt2 && _livEnt2.hasEffect(InvincibleConquestModMobEffects.AIR_DENSITY_EFFECT))) {
			...
			} else if (entity instanceof LivingEntity _livEnt4 && _livEnt4.hasEffect(InvincibleConquestModMobEffects.AIR_DENSITY_EFFECT)) {
