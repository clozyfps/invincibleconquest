...
public class CMDFactionDemoteOfficerProcedure {
			...
			if ((entity.getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerFactionRank).equals("Leader")) {
				if (!((new Object() {
					...
					if (((new Object() {
						...
						if (((new Object() {
						...
						}.getEntity()).getData(InvincibleConquestModVariables.PLAYER_VARIABLES).PlayerFactionRank).equals("Officer")) {
							{
							...
							if ((new Object() {
								...
								_player.displayClientMessage(Component.literal("<> You have been demoted from Officer."), false);
						} else {
							if (entity instanceof Player _player && !_player.level().isClientSide())
								_player.displayClientMessage(Component.literal("<> Player is not an Officer."), false);
						}
					} else {
						if (entity instanceof Player _player && !_player.level().isClientSide())
					...
					if (entity instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal("<> You cannot demote yourself."), false);
				}
			} else {
				if (entity instanceof Player _player && !_player.level().isClientSide())
