...
public class CMDFactionPromoteLeaderProcedure {
				...
				if (((new Object() {
					...
					if (!((new Object() {
						...
						if ((new Object() {
							...
							_player.displayClientMessage(Component.literal("<> You have been promoted to Leader!"), false);
					} else {
						if (entity instanceof Player _player && !_player.level().isClientSide())
							_player.displayClientMessage(Component.literal("<> You cannot promote yourself to Leader."), false);
					}
				} else {
					if (entity instanceof Player _player && !_player.level().isClientSide())
