...
public class MenuAbilityTechJacketMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	private void removeAction() {
		if (this.world != null && this.world.isClientSide()) {
			PacketDistributor.sendToServer(new MenuAbilityTechJacketButtonMessage(-2, x, y, z, MenuAbilityTechJacketScreen.getEditBoxAndCheckBoxValues()));
			MenuAbilityTechJacketButtonMessage.handleButtonAction(entity, -2, x, y, z, MenuAbilityTechJacketScreen.getEditBoxAndCheckBoxValues());
		}
	}
