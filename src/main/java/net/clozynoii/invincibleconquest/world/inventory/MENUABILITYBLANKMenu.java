...
public class MENUABILITYBLANKMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MENUABILITYBLANKMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(InvincibleConquestModMenus.MENUABILITYBLANK.get(), id);
