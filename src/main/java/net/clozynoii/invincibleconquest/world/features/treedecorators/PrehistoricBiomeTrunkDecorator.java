...
public class PrehistoricBiomeTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<PrehistoricBiomeTrunkDecorator> CODEC = MapCodec.unit(PrehistoricBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("invincible_conquest:prehistoric_biome_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
