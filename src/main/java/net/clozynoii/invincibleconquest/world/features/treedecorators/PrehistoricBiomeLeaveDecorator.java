...
package net.clozynoii.invincibleconquest.world.features.treedecorators;
...
public class PrehistoricBiomeLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<PrehistoricBiomeLeaveDecorator> CODEC = MapCodec.unit(PrehistoricBiomeLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("invincible_conquest:prehistoric_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public PrehistoricBiomeLeaveDecorator() {
		super(0.25f);
	}
