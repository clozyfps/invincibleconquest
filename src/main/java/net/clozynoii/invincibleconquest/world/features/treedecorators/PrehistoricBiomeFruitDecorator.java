...
public class PrehistoricBiomeFruitDecorator extends CocoaDecorator {
	public static MapCodec<PrehistoricBiomeFruitDecorator> CODEC = MapCodec.unit(PrehistoricBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("invincible_conquest:prehistoric_biome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public PrehistoricBiomeFruitDecorator() {
		super(0.2f);
	}
