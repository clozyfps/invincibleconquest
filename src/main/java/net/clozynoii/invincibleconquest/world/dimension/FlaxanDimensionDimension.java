...
import net.clozynoii.invincibleconquest.procedures.FlaxanDimensionPlayerEntersDimensionProcedure;
...
public class FlaxanDimensionDimension {
	...
	public static void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse("invincible_conquest:flaxan_dimension"))) {
			FlaxanDimensionPlayerEntersDimensionProcedure.execute(entity);
		}
	}
}
