...
public class FlaxanGunmanEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	public FlaxanGunmanEntity(EntityType<FlaxanGunmanEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(InvincibleConquestModItems.FLAXAN_GUN.get()));
	}
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "flaxan_gunman");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new FlaxanGunmanEntity.RangedAttackGoal(this, 1.25, 20, 10f) {
			@Override
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		FlaxanBulletEntity.shoot(this, target);
	}
