...
public class OmniManEntity extends TamableAnimal implements GeoEntity {
	...
	public OmniManEntity(EntityType<OmniManEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(InvincibleConquestModItems.OMNI_MAN_SUIT_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(InvincibleConquestModItems.OMNI_MAN_SUIT_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(InvincibleConquestModItems.OMNI_MAN_SUIT_BOOTS.get()));
	}
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "omniman");
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		OmniManEntity retval = InvincibleConquestModEntities.OMNI_MAN.get().create(serverWorld);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(InvincibleConquestModEntities.OMNI_MAN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
