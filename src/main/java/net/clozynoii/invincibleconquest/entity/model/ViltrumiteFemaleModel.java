...
public class ViltrumiteFemaleModel extends GeoModel<ViltrumiteFemaleEntity> {
	...
	public ResourceLocation getAnimationResource(ViltrumiteFemaleEntity entity) {
		return ResourceLocation.parse("invincible_conquest:animations/viltrumite_female.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(ViltrumiteFemaleEntity entity) {
		return ResourceLocation.parse("invincible_conquest:geo/viltrumite_female.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(ViltrumiteFemaleEntity animatable, long instanceId, AnimationState animationState) {
